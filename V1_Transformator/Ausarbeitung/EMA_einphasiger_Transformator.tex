	...
	\section{Versuchsvorbereitung}
		...
		\subsection{Simulation der Leerlaufkennlinie}
			...
			\subsubsection{Effektivwert des Leerlaufstroms $I_{10}$ über Effektivwert der Primärspannung $U_1$}
				...
				R_{Fe} = f(f)
				$$
				Etwaige Temperaturschwankungen, welche sich auf den Materialwiderstand $R_{Fe}$ auswirken, sind in Realität ebenfalls zu beachten, hier jedoch ausgeschlossen worden, da für die Simulation $R_{Fe}$ als unendlich angenommen wird.
